...
//	func main() {
//	    // Basic colors
//	    inkstamp.Parse("[fg=blue bg=yellow]Hello World![reset]").Println()
//
//	    // RGB colors
//	    inkstamp.Parse("[fg=rgb(255,105,180)]Hot pink text[reset]").Println()
//
//	    // Hex colors
//	    inkstamp.Parse("[fg=#FF5733]Orange text[reset]").Println()
//
//	    // 256-color palette
//	    inkstamp.Parse("[fg=214]Orange from palette[reset]").Println()
//
//	    // Styles
//	    inkstamp.Parse("[bold underline=single]Bold and underlined[reset]").Println()
//	}
//
// # Template System
//
// Inkstamp uses a template-first approach for optimal performance. Parse templates
// once and reuse them with different data:
//
//	// Parse once
//	errorTemplate := inkstamp.Parse("[fg=red bold]Error: [0][reset]")
//	warningTemplate := inkstamp.Parse("[fg=yellow]Warning: [0][reset]")
//
...
//	var itemTemplate = inkstamp.Parse("[fg=blue][0][reset]")
...
//	for _, item := range items {
//	    inkstamp.Parse("[fg=blue]" + item + "[reset]").Println()
//	}
//
...
//
//	header := inkstamp.Parse("[bold fg=cyan][0][reset]")
//	row := inkstamp.Parse("[0]  [fg=yellow][1][reset]  [fg=green][2][reset]")
//
...
//
//	logTemplate := inkstamp.Parse("[0] [fg=blue][1][reset]: [fg=yellow][2][reset]")
...
//
//	progress := inkstamp.Parse("[fg=cyan][0][reset]/[fg=cyan][1][reset] [fg=green][2][reset]%%")
//	for i := 0; i <= 100; i += 10 {
